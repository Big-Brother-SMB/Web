...
# certbot -d foyerlycee.stemariebeaucamps.fr certonly --manual #nano /var/www/html/.well-known/acme-challenge/
# configurer le certbot pour qu'il s'update automatiquement avec "renew":
# certbot -d foyerlycee.stemariebeaucamps.fr certonly --webroot #/var/www/html/
