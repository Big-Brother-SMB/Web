...
module.exports = async(req_url) => {
  ...
  try{
    ...
    if(pathName=="/google73a6482324b54c62.html" || pathName=="/sitemap.xml" || pathName=="/Robots.txt" || pathName=="/robots.txt"){  
      fichier = await readFileAsync(sources_url+"/indexation"+pathName)
